                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="page-title-right d-flex align-items-center">
                            <a id="add-accounts" href="#" class="btn btn-primary brand-bg-color">Add Accounts</a>
                        </div>
                    </div>
                                ...
                                foreach ($accounts as $account) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="../accounts/editaccount.php?id=<?= $account['id'] ?>"
                                            ...
                                            <?php if (isset($_SESSION['account']['is_admin']) && $_SESSION['account']['is_admin']) { ?>
                                                <button class="btn btn-sm btn-outline-danger deleteBtn"
                                                    data-id="<?= $account['id'] ?>"
                                                    data-name="<?= htmlspecialchars($account['username']) ?>">Delete</button>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <?php
